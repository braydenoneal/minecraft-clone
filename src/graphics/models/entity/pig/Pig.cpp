...
//    leg_back_right = {
//        {0.75, 0.0, 0.1875, 4, 6, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.375, 0.1875, 4, 12, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.0, 0.4375, 8, 6, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.375, 0.4375, 8, 12, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.0, 0.4375, 8, 6, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.375, 0.1875, 4, 12, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.0, 0.4375, 12, 6, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.375, 0.4375, 12, 12, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.0, 0.1875, 16, 6, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.375, 0.1875, 16, 12, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.0, 0.1875, 16, 6, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.375, 0.4375, 12, 12, 0, 0.8, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.0, 0.1875, 8, 16, 0, 0.4, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.0, 0.1875, 8, 12, 0, 0.4, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.0, 0.4375, 12, 16, 0, 0.4, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.0, 0.4375, 12, 12, 0, 0.4, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.0, 0.4375, 12, 16, 0, 0.4, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.0, 0.1875, 8, 12, 0, 0.4, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.375, 0.1875, 8, 16, 0, 1, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.375, 0.1875, 8, 12, 0, 1, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.375, 0.4375, 4, 16, 0, 1, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.375, 0.4375, 4, 12, 0, 1, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.375, 0.4375, 4, 16, 0, 1, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.375, 0.1875, 8, 12, 0, 1, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.0, 0.1875, 0, 6, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.375, 0.1875, 0, 12, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.0, 0.1875, 4, 6, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.375, 0.1875, 4, 12, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.0, 0.1875, 4, 6, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.375, 0.1875, 0, 12, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.0, 0.4375, 8, 6, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.375, 0.4375, 8, 12, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.0, 0.4375, 12, 6, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.375, 0.4375, 12, 12, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {1.0, 0.0, 0.4375, 12, 6, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//        {0.75, 0.375, 0.4375, 8, 12, 0, 0.6, 0.875, 0.375, 0.1875, 0, 0, 0.5},
//    };
//
...
void Pig::setUniforms(float aspect_ratio, glm::vec3 camera_position, glm::vec3 camera_angle, glm::vec3 position, glm::vec3 rotation) const {
    ...
    glm::mat4 camera_matrix = perspective * camera_rotate * camera_translate * model_rotate * model_translate;
