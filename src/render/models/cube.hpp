...
namespace cube {
    ...
    get_block(bool nx, bool px, bool ny, bool py, bool nz, bool pz, bool nx_ny, bool nx_py, bool px_ny, bool px_py,
        ...
        std::vector<std::vector<float>> meshes = {
                {
                        -0.5f, -0.5f, -0.5f, 0.0f, 0.0f, 0.0f, 0.8f - (float) ((nx_ny ? 1 : 0) + (nx_nz ? 1 : 0) + (nx_ny_nz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        -0.5f, +0.5f, -0.5f, 0.0f, 1.0f, 0.0f, 0.8f - (float) ((nx_py ? 1 : 0) + (nx_nz ? 1 : 0) + (nx_py_nz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        -0.5f, -0.5f, +0.5f, 1.0f, 0.0f, 0.0f, 0.8f - (float) ((nx_ny ? 1 : 0) + (nx_pz ? 1 : 0) + (nx_ny_pz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        -0.5f, +0.5f, +0.5f, 1.0f, 1.0f, 0.0f, 0.8f - (float) ((nx_py ? 1 : 0) + (nx_pz ? 1 : 0) + (nx_py_pz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        -0.5f, -0.5f, +0.5f, 1.0f, 0.0f, 0.0f, 0.8f - (float) ((nx_ny ? 1 : 0) + (nx_pz ? 1 : 0) + (nx_ny_pz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        -0.5f, +0.5f, -0.5f, 0.0f, 1.0f, 0.0f, 0.8f - (float) ((nx_py ? 1 : 0) + (nx_nz ? 1 : 0) + (nx_py_nz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                },
                {
                        +0.5f, +0.5f, -0.5f, 1.0f, 1.0f, 0.0f, 0.8f - (float) ((px_py ? 1 : 0) + (px_nz ? 1 : 0) + (px_py_nz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        +0.5f, -0.5f, -0.5f, 1.0f, 0.0f, 0.0f, 0.8f - (float) ((px_ny ? 1 : 0) + (px_nz ? 1 : 0) + (px_ny_nz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        +0.5f, +0.5f, +0.5f, 0.0f, 1.0f, 0.0f, 0.8f - (float) ((px_py ? 1 : 0) + (px_pz ? 1 : 0) + (px_py_pz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        +0.5f, -0.5f, +0.5f, 0.0f, 0.0f, 0.0f, 0.8f - (float) ((px_ny ? 1 : 0) + (px_pz ? 1 : 0) + (px_ny_pz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        +0.5f, +0.5f, +0.5f, 0.0f, 1.0f, 0.0f, 0.8f - (float) ((px_py ? 1 : 0) + (px_pz ? 1 : 0) + (px_py_pz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                        +0.5f, -0.5f, -0.5f, 1.0f, 0.0f, 0.0f, 0.8f - (float) ((px_ny ? 1 : 0) + (px_nz ? 1 : 0) + (px_ny_nz ? 1 : 0)) * (0.8f * 0.5f / 3.0f),
                },
                {
                        -0.5f, -0.5f, -0.5f, 1.0f, 1.0f, 2.0f, 0.4f - (float) ((nx_ny ? 1 : 0) + (ny_nz ? 1 : 0) + (nx_ny_nz ? 1 : 0)) * (0.4f * 0.5f / 3.0f),
                        -0.5f, -0.5f, +0.5f, 0.0f, 1.0f, 2.0f, 0.4f - (float) ((nx_ny ? 1 : 0) + (ny_pz ? 1 : 0) + (nx_ny_pz ? 1 : 0)) * (0.4f * 0.5f / 3.0f),
                        +0.5f, -0.5f, -0.5f, 1.0f, 0.0f, 2.0f, 0.4f - (float) ((px_ny ? 1 : 0) + (ny_nz ? 1 : 0) + (px_ny_nz ? 1 : 0)) * (0.4f * 0.5f / 3.0f),
                        +0.5f, -0.5f, +0.5f, 0.0f, 0.0f, 2.0f, 0.4f - (float) ((px_ny ? 1 : 0) + (ny_pz ? 1 : 0) + (px_ny_pz ? 1 : 0)) * (0.4f * 0.5f / 3.0f),
                        +0.5f, -0.5f, -0.5f, 1.0f, 0.0f, 2.0f, 0.4f - (float) ((px_ny ? 1 : 0) + (ny_nz ? 1 : 0) + (px_ny_nz ? 1 : 0)) * (0.4f * 0.5f / 3.0f),
                        -0.5f, -0.5f, +0.5f, 0.0f, 1.0f, 2.0f, 0.4f - (float) ((nx_ny ? 1 : 0) + (ny_pz ? 1 : 0) + (nx_ny_pz ? 1 : 0)) * (0.4f * 0.5f / 3.0f),
                },
                {
                        -0.5f, +0.5f, +0.5f, 1.0f, 1.0f, 1.0f, 1.0f - (float) ((nx_py ? 1 : 0) + (py_pz ? 1 : 0) + (nx_py_pz ? 1 : 0)) * (1.0f * 0.5f / 3.0f),
                        -0.5f, +0.5f, -0.5f, 0.0f, 1.0f, 1.0f, 1.0f - (float) ((nx_py ? 1 : 0) + (py_nz ? 1 : 0) + (nx_py_nz ? 1 : 0)) * (1.0f * 0.5f / 3.0f),
                        +0.5f, +0.5f, +0.5f, 1.0f, 0.0f, 1.0f, 1.0f - (float) ((px_py ? 1 : 0) + (py_pz ? 1 : 0) + (px_py_pz ? 1 : 0)) * (1.0f * 0.5f / 3.0f),
                        +0.5f, +0.5f, -0.5f, 0.0f, 0.0f, 1.0f, 1.0f - (float) ((px_py ? 1 : 0) + (py_nz ? 1 : 0) + (px_py_nz ? 1 : 0)) * (1.0f * 0.5f / 3.0f),
                        +0.5f, +0.5f, +0.5f, 1.0f, 0.0f, 1.0f, 1.0f - (float) ((px_py ? 1 : 0) + (py_pz ? 1 : 0) + (px_py_pz ? 1 : 0)) * (1.0f * 0.5f / 3.0f),
                        -0.5f, +0.5f, -0.5f, 0.0f, 1.0f, 1.0f, 1.0f - (float) ((nx_py ? 1 : 0) + (py_nz ? 1 : 0) + (nx_py_nz ? 1 : 0)) * (1.0f * 0.5f / 3.0f),
                },
                {
                        -0.5f, -0.5f, -0.5f, 1.0f, 0.0f, 0.0f, 0.6f - (float) ((nx_nz ? 1 : 0) + (ny_nz ? 1 : 0) + (nx_ny_nz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        +0.5f, -0.5f, -0.5f, 0.0f, 0.0f, 0.0f, 0.6f - (float) ((px_nz ? 1 : 0) + (ny_nz ? 1 : 0) + (px_ny_nz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        -0.5f, +0.5f, -0.5f, 1.0f, 1.0f, 0.0f, 0.6f - (float) ((nx_nz ? 1 : 0) + (py_nz ? 1 : 0) + (nx_py_nz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        +0.5f, +0.5f, -0.5f, 0.0f, 1.0f, 0.0f, 0.6f - (float) ((px_nz ? 1 : 0) + (py_nz ? 1 : 0) + (px_py_nz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        -0.5f, +0.5f, -0.5f, 1.0f, 1.0f, 0.0f, 0.6f - (float) ((nx_nz ? 1 : 0) + (py_nz ? 1 : 0) + (nx_py_nz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        +0.5f, -0.5f, -0.5f, 0.0f, 0.0f, 0.0f, 0.6f - (float) ((px_nz ? 1 : 0) + (ny_nz ? 1 : 0) + (px_ny_nz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                },
                {
                        +0.5f, -0.5f, +0.5f, 1.0f, 0.0f, 0.0f, 0.6f - (float) ((px_pz ? 1 : 0) + (ny_pz ? 1 : 0) + (px_ny_pz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        -0.5f, -0.5f, +0.5f, 0.0f, 0.0f, 0.0f, 0.6f - (float) ((nx_pz ? 1 : 0) + (ny_pz ? 1 : 0) + (nx_ny_pz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        +0.5f, +0.5f, +0.5f, 1.0f, 1.0f, 0.0f, 0.6f - (float) ((px_pz ? 1 : 0) + (py_pz ? 1 : 0) + (px_py_pz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        -0.5f, +0.5f, +0.5f, 0.0f, 1.0f, 0.0f, 0.6f - (float) ((nx_pz ? 1 : 0) + (py_pz ? 1 : 0) + (nx_py_pz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        +0.5f, +0.5f, +0.5f, 1.0f, 1.0f, 0.0f, 0.6f - (float) ((px_pz ? 1 : 0) + (py_pz ? 1 : 0) + (px_py_pz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                        -0.5f, -0.5f, +0.5f, 0.0f, 0.0f, 0.0f, 0.6f - (float) ((nx_pz ? 1 : 0) + (ny_pz ? 1 : 0) + (nx_ny_pz ? 1 : 0)) * (0.6f * 0.5f / 3.0f),
                }
        };
